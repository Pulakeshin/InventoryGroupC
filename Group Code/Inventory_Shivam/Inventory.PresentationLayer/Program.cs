    ...
    class Program
    {
        ...
        private static void DeleteGuest()
        {
            try
            {
                ...
                Entities.SupplierPaymentDetails deleteGuest = GuestBL.SearchGuestBL(deleteGuestID);
                if (deleteGuest != null)
                {
        ...
        private static void UpdateGuest()
        {
            try
            {
                ...
                Entities.SupplierPaymentDetails updatedGuest = GuestBL.SearchGuestBL(updateGuestID);
        ...
        private static void SearchGuestByID()
        {
            try
            {
                ...
                Entities.SupplierPaymentDetails searchGuest = GuestBL.SearchGuestBL(searchGuestID);
                if (searchGuest != null)
                {
                    Console.WriteLine("******************************************************************************");
        ...
        private static void ListAllGuests()
        {
            try
            {
                List<Entities.SupplierPaymentDetails> guestList = GuestBL.GetAllGuestsBL();
                if (guestList != null)
                {
                    Console.WriteLine("******************************************************************************");
                    Console.WriteLine("GuestID\t\tName\t\tPhoneNumber");
                    Console.WriteLine("******************************************************************************");
                    foreach (Entities.SupplierPaymentDetails guest in guestList)
                    {
        ...
        private static void AddGuest()
        {
            try
            {
                Entities.SupplierPaymentDetails newGuest = new Entities.SupplierPaymentDetails();
